...
if __name__ == "__main__":
    ...
    # split_dir = os.path.join(os.path.join(config['data_dir'], config['split_folder']), 'vggflowers')
    ...
    # organise_class_folders(image_folder_dir=dest_dir, label_mat_dir='../data/vggflowers_raw/imagelabels.mat')
    ...
    split_vggflowers = SplitGenerator(
        data_dir=os.path.join(config['data_dir'], 'vggflowers_raw'), dest_dir=dest_dir, split_dir=split_dir,
